...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.msToTime = void 0;\r\nfunction msToTime(ms) {\r\n    var seconds = parseInt((ms / 1000).toFixed(1)), б;\r\n    var minutes = parseInt((ms / (1000 * 60)).toFixed(1));\r\n    var hours = parseInt((ms / (1000 * 60 * 60)).toFixed(1));\r\n    var days = parseInt((ms / (1000 * 60 * 60 * 24)).toFixed(1));\r\n    var ref_days = declension(['день', 'дня', 'дней'], days), ref_hours = declension(['час', 'часа', 'часов'], hours), ref_minutes = declension(['минута', 'минуты', 'минут'], minutes), ref_seconds = declension(['секунда', 'секунды', 'секунд'], seconds);\r\n    if (seconds < 60)\r\n        return seconds + \" Sec\";\r\n    else if (minutes < 60)\r\n        return minutes + \" Min\";\r\n    else if (hours < 24)\r\n        return hours + \" Hrs\";\r\n    else\r\n        return days + \" Days\";\r\n}\r\nexports.msToTime = msToTime;\r\n\n\n//# sourceURL=webpack://react-training/./src/utils/js/msToTime.ts?");
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("f9bc6e0d0aea1257cbd5")
/******/ })();
/******/ 
/******/ }
);