...
const LIST = [
  {
    СhildAs: 'a' as const,
    itemWrapperClassName: styles.itemWrapper + ' ' + styles.itemWrapper_tabletMin,
  ...
  {
    СhildAs: 'a' as const,
    itemWrapperClassName: styles.itemWrapper + ' ' + styles.itemWrapper_tabletMax,
    itemClassName: styles.item + ' ' + styles.item_close,
    text: 'Закрыть',
    href: '#close',
  },
].map(generateId);
